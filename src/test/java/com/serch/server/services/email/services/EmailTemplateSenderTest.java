...
@ContextConfiguration(classes = {EmailTemplateSender.class})
@ExtendWith(SpringExtension.class)
class EmailTemplateSenderTest {
    @Autowired
    private EmailTemplateSender emailAuthSender;

    @MockBean
    private EmailService emailService;

    /**
     * Method under test: {@link EmailTemplateSender#sendSignup(String, String)}
     */
    @Test
    void testSendSignup() {
        // Arrange
    ...
    /**
     * Method under test: {@link EmailTemplateSender#sendReset(String, String, String)}
     */
    @Test
    void testSendReset() {
        // Arrange
