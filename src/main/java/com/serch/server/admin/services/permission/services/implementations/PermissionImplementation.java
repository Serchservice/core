package com.serch.server.admin.services.permission.services.implementations;
...
import com.serch.server.admin.repositories.permission.GrantedPermissionRepository;
import com.serch.server.admin.repositories.permission.GrantedPermissionScopeRepository;
import com.serch.server.admin.repositories.permission.RequestedPermissionRepository;
...
public class PermissionImplementation implements PermissionService {
        ...
        scopes.stream()
                ...
                .forEach(entry -> {
                    ...
                    notificationService.create(
                            ...
                            String.valueOf(getRequestedPermission(admin, account, scope, permission).getId()),
    ...
    private RequestedPermission getRequestedPermission(Admin admin, String account, PermissionScopeRequest scope, PermissionRequestDto permission) {
        ...
        return requestedPermissionRepository.save(request);
    }
    ...
    private PermissionRequestResponse getPermissionRequestResponse(Admin admin, RequestedPermission permission) {
        ...
        request.setDetails(getPermissionRequestDetails(admin, permission));

        return request;
    }

    private PermissionRequestDetails getPermissionRequestDetails(Admin admin, RequestedPermission permission) {
