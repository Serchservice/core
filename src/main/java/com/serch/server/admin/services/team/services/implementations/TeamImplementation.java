package com.serch.server.admin.services.team.services.implementations;
...
import com.serch.server.admin.services.team.responses.AdminGroupResponse;
...
public class TeamImplementation implements TeamService {
    ...
    public CompanyStructure team() {
        ...
        CompanyStructure superAdminNode = AdminMapper.instance.structure(superAdmin);
    ...
    private void addChildren(CompanyStructure parentNode, UUID parentId, Map<UUID, List<Admin>> adminsByAddedBy) {
        ...
        if (children != null && !children.isEmpty()) {
            for (Admin child : children) {
                CompanyStructure childNode = AdminMapper.instance.structure(child);
