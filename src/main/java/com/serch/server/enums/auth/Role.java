...
public enum Role {
    USER(Set.of(
            ...
            AuthPermission.USER_WRITE,
            AuthPermission.USER_UPDATE,
            AuthPermission.USER_DELETE
    ), "User"),
    PROVIDER(Set.of(
            AuthPermission.PROVIDER_READ,
            AuthPermission.PROVIDER_WRITE,
            AuthPermission.PROVIDER_UPDATE,
            AuthPermission.PROVIDER_DELETE
    ), "Provider"),
    ASSOCIATE_PROVIDER(Set.of(
            AuthPermission.ASSOCIATE_PROVIDER_READ,
            AuthPermission.ASSOCIATE_PROVIDER_WRITE,
            AuthPermission.ASSOCIATE_PROVIDER_UPDATE,
            AuthPermission.ASSOCIATE_PROVIDER_DELETE
    ), "Associate"),
    BUSINESS(Set.of(
            AuthPermission.BUSINESS_READ,
            AuthPermission.BUSINESS_WRITE,
            AuthPermission.BUSINESS_UPDATE,
            AuthPermission.BUSINESS_DELETE
    ), "Business"),
    SUPER_ADMIN(Set.of(), "Super Administrator"),
    ADMIN(Set.of(), "Administrator"),
