...
public class SwaggerConfiguration {
                ...
                .info(new Info()
                        ...
                        .description("""
                                This API supports four authentication methods:
                                 ...
                                 3. **Drive Authentication**: Optionally, use the `X-Serch-Drive-Api-Key` and `X-Serch-Drive-Secret-Key` and `Go-Authorization` headers for Drive/Nearby authentication.
    ...
    private Components getSecurityComponent() {
        ...
        components.addSecuritySchemes(
                "Go Authorization",
                getApiKeyScheme("Go-Authorization", "Go user authentication")
        );
        ...
        components.addSecuritySchemes(
                "Guest Authorization",
                getApiKeyScheme("Guest-Authorization", "Guest user authentication")
        );
