...
public interface CommonAuthService {
     ...
     * @param id The ID of the user whose MFA challenges are being requested.
     ...
     */
    List<AccountMFAChallengeResponse> challenges(UUID id, Integer page, Integer size);
     ...
     * @param page The page number to retrieve (zero-based index).
     * @param size The number of items per page.
     * @param id The ID of the user whose session history is being requested.
     ...
     */
    List<AccountSessionResponse> sessions(UUID id, Integer page, Integer size);
     ...
     * @param page The page number to retrieve (zero-based index).
     * @param size The number of items per page.
     * @param id The ID of the user whose device history is being requested.
     * @return List of {@link AccountAuthDeviceResponse} representing the user's devices.
     */
    List<AccountAuthDeviceResponse> devices(UUID id, Integer page, Integer size);
     ...
     * @param page The page number to retrieve (zero-based index).
     * @param size The number of items per page.
     * @param id The ID of the user for whom the authentication overview is being requested.
     *             This is used to quickly assess the security posture of the user's account.
     * @return {@link AccountAuthResponse} or any inheriting class of {@link AccountAuthResponse} summarizing the user's MFA factors and session details.
     */
    <T extends AccountAuthResponse> T auth(UUID id, Integer page, Integer size, T response);
