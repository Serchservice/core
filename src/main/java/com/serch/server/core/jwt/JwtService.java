...
public interface JwtService {
     ...
     * </p>
     *
     * @param data   The data for the token, typically containing claims and user
     ...
     * data in the token itself.
     * </p>
     *
     * @param tokenRequest The session token request containing necessary data for
     *                     token generation.
     * @return The generated JWT token as a {@link String}.
     *
     * @see RequestSessionToken
