package com.serch.server.core.payment.services;
...
import com.serch.server.core.payment.services.implementations.Payment;
...
public interface PaymentService {
    ...
    /**
     * Initializes a payment transaction based on the provided request response.
     * <p>
     * This method sets up the necessary information for a payment transaction and returns
     * the initialized payment response, which can be used to proceed with the payment process.
     * </p>
     *
     * @param request The request object containing payment initialization response, including
     *                the amount, currency, and payment method details.
     * @return An object representing the initialized payment response, including the transaction
     ...
     * @return An object representing the payment verification response, which includes the status
